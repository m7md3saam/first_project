...
function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-kh-wa rounded-full flex items-center justify-center
        ...
        <Route path="*" element={
          <PublicLayout>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-32 text-center">
              <h1 className="font-heading text-7xl font-800 text-kh-black mb-4">404</h1>
              <p className="font-body text-kh-muted mb-8">Page not found.</p>
